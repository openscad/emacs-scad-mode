...
#+html: <a href="https://releases.melpa.org/#/scad-mode"><img alt="MELPA Releases" src="https://releases.melpa.org/packages/scad-mode-badge.svg"/></a>
#+html: <a href="https://snapshots.melpa.org/#/scad-mode"><img alt="MELPA Snapshots" src="https://snapshots.melpa.org/packages/scad-mode-badge.svg"/></a>
...
Install via =M-x package-install RET scad-mode RET= from [[https://elpa.nongnu.org/nongnu/scad-mode.html][ELPA]] or [[https://releases.melpa.org/#/scad-mode][MELPA]].
